...
public class Teatro {
	...
	public Teatro(String nombre, Direccion direccion, Funcion[] funciones) {
		this.nombre = nombre;
		setDireccion(direccion); // composiciÃ³n
		
		setFunciones(funciones); // agregaciÃ³n
	}
	...
	public void setFunciones(Funcion[] funciones) {
		if (this.funciones == null) // si no estÃ¡ creado el array
	...
	public void leerOtrosDatos() {
		...
		// tiene que ser una funciÃ³n que exista.
